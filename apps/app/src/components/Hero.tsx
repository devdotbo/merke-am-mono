...
export const Hero: React.FC<HeroComponentProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast("Query submitted!", { description: `Processing: "${inputValue}"${attachedFiles.length ? ` with ${attachedFiles.length} file(s)` : ""}`, duration: 3000 });
    setInputValue("");
    setAttachedFiles([]);
      ...
      <div className="relative z-[5] container mx-auto pl-4 pr-8 md:pr-16 lg:pr-24 xl:pr-32 py-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <motion.form onSubmit={handleSubmit} className="w-full max-w-2xl mx-auto" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.0, delay: 0.35, ease: "easeOut" }}>
